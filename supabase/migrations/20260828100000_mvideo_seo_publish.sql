-- MVIDEO-8: SEO publish allowlist DB CHECKs for mvideo.
...
comment on constraint seo_product_pages_marketplace_check on public.seo_product_pages is
  'CORE trio + megamarket + aliexpress + mvideo (MEGA-8/ALI-8/MVIDEO-8 SEO publishAllowed). Gates still apply per page.';
...
-- offers_snapshot cross-MP mapping may include M.Video as source or target
